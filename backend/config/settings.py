...
Progress: 1 of 7 files emitted.

### Checkpoint 4 — Pre-Emission: Each File

Pre-emit File 2: backend/models/nav/menu_item.py
Responsibility: Models for navigation entities (Story 1).
Dependencies required: None.
New exports to ledger: MenuItem class.
Epic Title comment: will be injected at line 1.
Proceeding to emit.

### Emitting File 2: backend/models/nav/menu_item.py