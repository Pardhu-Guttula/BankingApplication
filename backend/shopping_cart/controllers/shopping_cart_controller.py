...
@shopping_cart_bp.route('/cart/<int:user_id>/update', methods=['POST'])
def update_cart(user_id: int):
    ...
    success = shopping_cart_repository.update_item_quantity(user_id, product_id, quantity)
