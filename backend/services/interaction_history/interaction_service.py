...
class InteractionService:
    ...
    def track_data_export(self, user_id: str) -> InteractionRecord:
        interaction = InteractionRecord(
            interaction_id=str(uuid.uuid4()),
            user_id=user_id,
    ...
    def track_anomaly_detection(self, user_id: str, message: str) -> InteractionRecord:
        interaction = InteractionRecord(
            interaction_id=str(uuid.uuid4()),
            user_id=user_id,
